...
## [2.11.0](https://github.com/camjac251/rust-statusline/compare/v2.10.0...v2.11.0) - 2026-07-29

### Added

- *(usage)* report how stale the usage figures are
...
- *(display)* distinguish disabled effort

### Other

- explain namespaced pricing and model colors
...
- *(usage)* keep 5h window reset time accurate to the minute
...
- *(prompt-cache)* show same-turn cache hits

## [1.4.2](https://github.com/camjac251/rust-statusline/compare/v1.4.1...v1.4.2) - 2026-05-01

### Fixed

- *(prompt-cache)* separate write and hit ages
